...
public abstract class EvalInJava2Double {
    ...
    public static void main(String[] args) throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        // 순수 연산
        System.out.println(EvalInJava2Double.solveNumericExpression("1+3*9"));

        // 기본 + 띄어쓰기
        HashMap<String, Double> values = new HashMap<>();
        values.put("x", 4.0);
        System.out.println(EvalInJava2Double.solve("x-3", values));
        System.out.println(EvalInJava2Double.solve("x- 3", values));
        System.out.println(EvalInJava2Double.solve("x -3", values));
        System.out.println(EvalInJava2Double.solve("x - 3", values));
        ...
        values2.put("y", 6.0);
        values2.put("z", 8.0);
        System.out.println(EvalInJava2Double.solve("x * (y - 301)", values2));  // 꼭 다 쓸 필요도 없음       
    }
