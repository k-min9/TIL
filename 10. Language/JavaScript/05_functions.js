...
// 1. function 키워드를 지운다.
// 2. () 와 {} 사이에 => 를 넣는다.
// 3. [optional] 인자가 하나일 경우에는 () 생략 가능
// 4. [optional] 블록{} 안의 코드가 return 문 포함 한줄일 경우에는 {} 와 return 모두 생략가능

const celsiusToFahrenheit = celsius => celsius * 9/5 + 32
const celsiusToFahrenheit = (celsius=36.5) => celsius * 9/5 + 32
